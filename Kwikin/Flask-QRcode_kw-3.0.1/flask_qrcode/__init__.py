...
class QRcode(object):
    ...
    @classmethod
    def qrcode(cls, data, mode="base64", version=1, error_correction="L",
               box_size=10, border=4, fit=True, fill_color="black",
        ...
        start_date = "Valido: {} ".format(kwargs["start_date"])  ### kwargs["start_date"]
        end_date = "Hasta: {} ".format(kwargs["end_date"])  ## kwargs["end_date"]
        font = ImageFont.truetype('arial.ttf', 20)
        draw.text((42, 6), start_date, font=font, fill="#000")
        draw.text((42, height - 35), end_date, font=font, fill="#000")
        qr_img.save(out, 'PNG')
        out.seek(0)
    ...
    @staticmethod
    def _insert_img(qr_img, icon_img=None, factor=4, icon_box=None, start_date=None, end_date=None,
                    static_dir=None):
