...
def usuario_notificaciones(f):
    ...
    def decorated_function(**kws):
        ...
        try:
            ...
            try:
                cont = comunic.find({"$and": [{"leido": 0}, {"email_usuario_receptor": correo}, {"coto": coto}]}).count() #contabiliza los comunicados
            except:
                cont = 0 #si no hay comunicados sin leer, se sobrepone 0
