    ...
    return function (n) {
        ...
        function p(e, n, r, i) {
                ...
                () : function () {
                    ...
                    if (_.keywords) {
                        for (n = 0, _.lexemesRe.lastIndex = 0, t = _.lexemesRe.exec(k), r = ""; t; ) {
                            ...
                            var a = null;
                            (e = l(_, t)) ? (w.addText(r), r = "", T += e[1], a = e[0], w.addKeyword(t[0], a)) : r += t[0],
            ...
            function b(n, t) {
                ...
                (t);
                if ("illegal" === t.type && !r)
                    throw (a = Error('Illegal lexeme "' + i + '" for mode "' + (_.className || "<unnamed>") + '"')).mode = _, a;
                if ("end" === t.type) {
                    var l = function (e) {
                        var n = e[0],
                        t = s.substr(e.index),
                        ...
                        if (r) {
                            ...
                            return r.starts && (r.endSameAsBegin && (r.starts.endRe = r.endRe), h(r.starts)),
            ...
            B = !1;
            try {
                for (_.matcher.considerAll(); A++, B ? B = !1 : (_.matcher.lastIndex = L, _.matcher.considerAll()), y = _.matcher.exec(s); )
        ...
        function v(e) {
            ...
            o = function (e) {
                ...
                if (t += e.parentNode ? e.parentNode.className : "", n = g.languageDetectRe.exec(t)) {
                    var r = M(n[1]);
                    return r || (console.warn(d.replace("{}", n[1])), console.warn("Falling back to no-highlight mode for this block.", e)),
                    r ? n[1] : "no-highlight"
                }
...
hljs.registerLanguage("kotlin", function () {
    ...
    return function (e) {
        ...
        d = o;
        return d.variants[1].contains = [o],
